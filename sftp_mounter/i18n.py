...
TRANSLATIONS = {
    ...
    'binary_integrity_title': {
        'es': '🔒 Integridad y Verificación SHA-256',
        'en': '🔒 Binary Integrity & SHA-256 Verification',
        'fr': '🔒 Intégrité et vérification SHA-256',
        'pt': '🔒 Integridade e verificação SHA-256',
        'de': '🔒 Integrität und SHA-256-Überprüfung',
        'it': '🔒 Integrità e verifica SHA-256',
        'hi': '🔒 द्विआधारी सत्यनिष्ठा और SHA-256 सत्यापन',
        'zh': '🔒 二进制完整性与 SHA-256 校验',
        'ru': '🔒 Целостность бинарных файлов и проверка SHA-256',
        'ro': '🔒 Integritate și verificare SHA-256'
    },
    'binary_verified': {
        'es': '✓ Verificado con el proveedor',
        'en': '✓ Verified with provider',
        'fr': '✓ Vérifié auprès del fournisseur',
        'pt': '✓ Verificado com o provedor',
        'de': '✓ Vom Anbieter verifiziert',
        'it': '✓ Verificato con il fornitore',
        'hi': '✓ प्रदाता के साथ सत्यापित',
        'zh': '✓ 已通过供应商校验',
        'ru': '✓ Проверено у поставщика',
        'ro': '✓ Verificat cu furnizorul'
    },
    'binary_hash_error': {
        'es': '⚠️ No coincide el hash del proveedor',
        'en': '⚠️ Provider hash mismatch',
        'fr': '⚠️ Incohérence del hachage',
        'pt': '⚠️ Incompatibilidade de hash',
        'de': '⚠️ Hash-Abweichung des Anbieters',
        'it': '⚠️ Mancata corrispondenza hash',
        'hi': '⚠️ हैश बेमेल',
        'zh': '⚠️ 哈希不匹配',
        'ru': '⚠️ Несовпадение хеша',
        'ro': '⚠️ Potrivire incorectă a hash-ului'
    },
    'menu_verify_integrity': {
        'es': 'Verificar integridad online',
        'en': 'Verify integrity online',
        'fr': 'Vérifier l\'intégrité en ligne',
        'pt': 'Verificar integridade online',
        'de': 'Integrität online überprüfen',
        'it': 'Verifica integrità online',
        'hi': 'ऑनलाइन सत्यनिष्ठा सत्यापित करें',
        'zh': '在线验证完整性',
        'ru': 'Проверить целостность онлайн',
        'ro': 'Verifică integritatea online'
    },
    'integrity_dialog_title': {
        'es': 'Verificación de Integridad Online (SHA-256)',
        'en': 'Online Binary Integrity Check (SHA-256)',
        'fr': 'Vérification d\'intégrité en ligne (SHA-256)',
        'pt': 'Verificação de integridade online (SHA-256)',
        'de': 'Online-Integritätsprüfung (SHA-256)',
        'it': 'Verifica di integrità online (SHA-256)',
        'hi': 'ऑनलाइन बाइनरी सत्यनिष्ठा जांच (SHA-256)',
        'zh': '在线二进制完整性检查 (SHA-256)',
        'ru': 'Онлайн проверка целостности (SHA-256)',
        'ro': 'Verificare de integritate online (SHA-256)'
    },
    'integrity_checking': {
        'es': 'Calculando hashes locales y consultando servidores oficiales en GitHub...',
        'en': 'Calculating local hashes and querying official GitHub servers...',
        'fr': 'Calcul des hachages locaux et interrogation des serveurs GitHub officiels...',
        'pt': 'Calculando hashes locais e consultando servidores oficiais do GitHub...',
        'de': 'Lokale Hashes berechnen und offizielle GitHub-Server abfragen...',
        'it': 'Calcolo degli hash locali e consultazione dei server GitHub ufficiali...',
        'hi': 'स्थानीय हैश की गणना की जा रही है और आधिकारिक GitHub सर्वर से पूछताछ की जा रही है...',
        'zh': '正在计算本地哈希并查询 GitHub 官方服务器...',
        'ru': 'Расчет локальных хешей и запрос к официальным серверам GitHub...',
        'ro': 'Se calculează hash-urile locale și se interoghează serverele GitHub oficiale...'
    },
    'integrity_match': {
        'es': '✓ Coincide con la versión oficial remota del proveedor',
        'en': '✓ Matches official remote provider release',
        'fr': '✓ Correspond a la versión officielle distante del fournisseur',
        'pt': '✓ Corresponde à versão oficial remota do provedor',
        'de': '✓ Stimmt mit dem offiziellen Remote-Release des Anbieters überein',
        'it': '✓ Corrisponde alla versione ufficiale remota del fornitore',
        'hi': '✓ प्रदाता की आधिकारिक रिमोट रिलीज़ से मेल खाता है',
        'zh': '✓ 与供应商官方远程版本匹配',
        'ru': '✓ Совпадает с официальным релизом поставщика',
        'ro': '✓ Se potrivește cu versiunea oficială de la distanță a furnizorului'
    },
    'integrity_mismatch': {
        'es': '⚠️ El hash local NO coincide con el servidor remoto',
        'en': '⚠️ Local hash does NOT match remote server',
        'fr': '⚠️ Le hachage local NE correspond PAS au serveur distant',
        'pt': '⚠️ O hash local NÃO corresponde ao servidor remoto',
        'de': '⚠️ Lokaler Hash stimmt NICHT mit dem Remote-Server überein',
        'it': '⚠️ L\'hash locale NON corrisponde al server remoto',
        'hi': '⚠️ स्थानीय हैश रिमोट सर्वर से मेल नहीं खाता',
        'zh': '⚠️ 本地哈希与远程服务器不匹配',
        'ru': '⚠️ Локальный хеш НЕ совпадает с удаленным сервером',
        'ro': '⚠️ Hash-ul local NU se potrivește cu serverul la distanță'
    },
    'integrity_remote_unavailable': {
        'es': 'ℹ️ No se pudo obtener el hash remoto del servidor oficial',
        'en': 'ℹ️ Could not fetch remote hash from official server',
        'fr': 'ℹ️ Impossible de récupérer le hachage distant du serveur officiel',
        'pt': 'ℹ️ Não foi possível obter o hash remoto do servidor oficial',
        'de': 'ℹ️ Remote-Hash vom offiziellen Server konnte nicht abgerufen werden',
        'it': 'ℹ️ Impossibile recuperare l\'hash remoto dal server ufficiale',
        'hi': 'ℹ️ आधिकारिक सर्वर से रिमोट हैश प्राप्त नहीं किया जा सका',
        'zh': 'ℹ️ 无法从官方服务器获取远程哈希',
        'ru': 'ℹ️ Не удалось получить удаленный хеш с официального сервера',
        'ro': 'ℹ️ Nu s-a putut prelua hash-ul de la distanță de pe serverul oficial'
    },
    'host': {
